(define (domain nestedqnp10)
	...
	(:action a9
		...
		:effect (and (gr0_1) (gr0_2) (gr0_3) (gr0_4) (gr0_5) (gr0_6) (gr0_7) (gr0_8) (oneof (gr0_9) (not (gr0_9))) (not (p))))
	(:action a10
		:parameters ()
		:precondition (and (gr0_10) (p) (not (gr0_9)))
		:effect (and (gr0_1) (gr0_2) (gr0_3) (gr0_4) (gr0_5) (gr0_6) (gr0_7) (gr0_8) (gr0_9) (oneof (gr0_10) (not (gr0_10))) (not (p))))
	(:action b
		:parameters ()
		:precondition (not (p))
		:effect (p)))