...
def get_experiments():
    ...
    add_pddl_experiment(unfair_qnp, 'gripper_unfair_01', 'gripper_unfair_01',
                        ...
                        DEFAULT_OUT_QNP/'gripper_unfair_01', fcfond.planner.FONDPLUS)
    ...
    add_pddl_experiment(unfair_qnp, 'delivery_unfair_01', 'delivery_unfair_01',
                            ...
                            DEFAULT_OUT_QNP/'delivery_unfair_01', fcfond.planner.FONDPLUS)
    ...
    for i in range(2, 11):
        ...
        add_pddl_experiment(sequential, 'sequential%s'%(si), 'sequential%s'%(si),
                        ...
                        DEFAULT_OUT_QNP/'sequential'/('p%s'%(si)), fcfond.planner.FONDPLUS)
    ...
    for i in range(2, 11):
        ...
        add_pddl_experiment(nested, 'nested%s'%(si), 'nested%s'%(si),
                        ...
                        DEFAULT_OUT_QNP/'nested'/('p%s'%(si)), fcfond.planner.FONDPLUS)
    ...
    add_clingo_experiment(experiments, 'nested08_clingo', 'nested08_clingo', CLINGO_DOM_PATHS/'qnp'/'nested'/'nested08.lp',DEFAULT_OUT_QNP/'nested'/'p08_clingo', fcfond.planner.FONDPLUS)
    ...
    add_clingo_experiment(experiments, 'nested08_simple_clingo', 'nested08_simple_clingo', CLINGO_DOM_PATHS/'qnp'/'nested'/'nested08_simple.lp',DEFAULT_OUT_QNP/'nested'/'p08_simple_clingo', fcfond.planner.FONDPLUS)
